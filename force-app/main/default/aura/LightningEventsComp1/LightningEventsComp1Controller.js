({
    ...
    handleRegisteredCompoenntEnvet : function(component, event, helper) {
        alert('Event handle in source component that fired the event.');
        //event.stopPropagation();
    },
    toggleIncomeForm : function(component, event, helper) {
        console.log('toggleIncomeForm');
    ...
    addIncome : function(component, event, helper) {
        ...
        if(newIncome.source != '' && newIncome.source != null && newIncome.amount != '' && newIncome.amount != null){
